...
extern void dm6006_fbdata(Joint_Motor_t *motor, uint8_t *rx_data,
                          uint32_t data_len);
extern void dm4340_fbdata(Joint_Motor_t *motor, uint8_t *rx_data,
                          uint32_t data_len);
extern void dm4310_fbdata(Joint_Motor_t *motor, uint8_t *rx_data,
                          uint32_t data_len);
extern void dm8006_fbdata(Joint_Motor_t *motor, uint8_t *rx_data,
                          uint32_t data_len);
extern void dm3507_fbdata(Joint_Motor_t *motor, uint8_t *rx_data,
                          uint32_t data_len);
extern void dm10010l_fbdata(Joint_Motor_t *motor, uint8_t *rx_data,
                            uint32_t data_len);
extern void dm6248p_fbdata(Joint_Motor_t *motor, uint8_t *rx_data,
                           uint32_t data_len);

extern void enable_motor_mode(hcan_t *hcan, uint16_t motor_id,
                              uint16_t mode_id);
extern void disable_motor_mode(hcan_t *hcan, uint16_t motor_id,
                               uint16_t mode_id);

// 4310
extern void mit_ctrl(hcan_t *hcan, uint16_t motor_id, float pos, float vel,
                     float kp, float kd, float torq);
extern void pos_speed_ctrl(hcan_t *hcan, uint16_t motor_id, float pos,
                           float vel);
extern void speed_ctrl(hcan_t *hcan, uint16_t motor_id, float _vel);

// 4340
extern void mit_ctrl2(hcan_t *hcan, uint16_t motor_id, float pos, float vel,
                      float kp, float kd, float torq);
// 6006
extern void mit_ctrl3(hcan_t *hcan, uint16_t motor_id, float pos, float vel,
                      float kp, float kd, float torq);
// 8006
extern void mit_ctrl4(hcan_t *hcan, uint16_t motor_id, float pos, float vel,
                      float kp, float kd, float torq);
// 3507
extern void mit_ctrl5(hcan_t *hcan, uint16_t motor_id, float pos, float vel,
                      float kp, float kd, float torq);
...
extern void mit_ctrl_test(hcan_t *hcan, uint16_t motor_id,
                          Joint_Motor_t *motor);
